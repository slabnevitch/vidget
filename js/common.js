...
var $details = $('.sidebar__detail'),
		detailsTop = $('.sidebar__detail').offset().top;
$window.scroll(function() {
	...
	if(scroll > detailsTop){
		$details.addClass('sidebar__detail--fixed');
	}else{
		$details.removeClass('sidebar__detail--fixed');
